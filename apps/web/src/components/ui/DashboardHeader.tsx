  ...
  return (
    ...
    >
      ...
      {isSettings && (
        ...
        >
          <span className="icon-[fa6-solid--arrow-right-to-bracket] block" />
          <span>Sair</span>
        </button>
      )}
      {(isDashboard || isPreview) && (
        ...
        >
          <span className="icon-[fa6-solid--arrow-up-right-from-square] block"></span>
          <span>Visitar</span>
        </Link>
      )}
      {isDashboard && (
        ...
        >
          <span className="icon-[fa6-solid--eye] block"></span>
          <span>Prévia</span>
        </Link>
      )}
    </header>
