...
export function SlidingView({ views, currentView, autoFocus }: Props) {
      ...
      >
        {viewKeys.map((key, index) => (
          <div
            ...
            // @ts-expect-error Ignore experimental types for "inert",
            // boolean support in react 19 only
            inert={key !== currentView ? "" : undefined}
